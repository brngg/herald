...
def _prompt_safe_observations(observations: ObservationBundle) -> dict[str, Any]:
    ...
    return {
        ...
        "kubernetes_summary": {
            ...
            "service": _section_prompt_summary(observations.kubernetes.get("service_summary")),
            "endpoint_slices": _section_prompt_summary(observations.kubernetes.get("endpoint_slice_summary")),
            "dependencies": _section_prompt_summary(observations.kubernetes.get("dependency_summary")),
            "config_maps": _section_prompt_summary(observations.kubernetes.get("config_map_summary")),
            "secrets": _section_prompt_summary(observations.kubernetes.get("secret_summary")),
            "nodes": _section_prompt_summary(observations.kubernetes.get("node_condition_summary")),
            "hpas": _section_prompt_summary(observations.kubernetes.get("hpa_summary")),
            "pvcs": _section_prompt_summary(observations.kubernetes.get("pvc_summary")),
            "resource_quotas": _section_prompt_summary(observations.kubernetes.get("resource_quota_summary")),
